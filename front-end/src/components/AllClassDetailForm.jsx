...
import AllClassDetailTable from "./AllClassDetailTable";
import { useDispatch, useSelector } from "react-redux";
import { getAllClassDetail } from "../features/ClassDetail/classdetailSlice";
const { Option } = Select;
...
const AllClassDetailForm = () => {
  ...
  // console.log("this is from all class detailtable", classdetails);
  ...
  return (
    <>
      ...
      <div style={listStyle}>
        <AllClassDetailTable classdetails={classdetails} />
      </div>
    </>
  );
};
